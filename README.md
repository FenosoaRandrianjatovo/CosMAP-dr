...
CosMAP (**Contrastive Manifold Approximation and Projection**) is an unsupervised dimensionality-reduction algorithm, and its estimator follows a scikit-learn-like API.
