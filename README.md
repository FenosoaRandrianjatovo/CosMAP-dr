...
We introduce **Contrastive Manifold Approximation and Projection** (CosMAP), a graph-based unsupervised dimensionality-reduction method
designed to produce more faithful and interpretable low-dimensional representations. CosMAP
